...
<div class="container">
    <%--    <h2>Faculty Details Form</h2>--%>
    <form:form modelAttribute="student" action="/StudentAttendanceManagementSystem_war_exploded/saveStudent" method="post">
        ...
        <div class="form-group">
            ...
            <form:input path="fathersName" id="fathersName"/>
        </div>
        <div class="form-group">
            <label for="mothersName">Mothers Name:</label>
            <form:input path="mothersName" id="mothersName"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <form:input path="course" id="course"/>
        </div>
        <div class="form-group">
